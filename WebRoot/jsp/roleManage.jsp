				...
				<!-- PAGE CONTENT BEGINS -->
					...
					<div class="form-group" >
						...
						<div class = "form-horizontal">
							<div class="col-sm-9">
							<label class="col-sm-1 control-label no-padding-left" for="form-field-1">角色名:</label>
								<input type="text" id="username" name="user_name"  class="col-xs-10 col-sm-3" />
								<label class="col-sm-2 control-label no-padding-left" for="form-field-1">备注:</label>
